...
namespace SharePointSuitebarCustomization.ControlTemplates.SharePointSuitebarCustomization
{
    public partial class SuiteLinksControl : UserControl
    {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            var cacheName = rootWeb.Title.ToString(CultureInfo.InvariantCulture) + Constants.SuiteBarLinksBoxName;
            ...
            if (dataItems == null)
            {
                ...
                {
                    Query = string.Format(Constants.ItemQuery, Constants.SuiteBarLinksBoxName)
                };
